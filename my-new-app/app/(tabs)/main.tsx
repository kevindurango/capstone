      ...
      >
        ...
        <View style={styles.quickActionsContainer}>
          ...
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => navigateToSection("explore-services")}
            >
              <View style={styles.actionIconContainer}>
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => navigateToSection("news")}
            >
              <View style={styles.actionIconContainer}>
                <Ionicons name="newspaper" size={32} color={COLORS.primary} />
              </View>
              <ThemedText style={styles.actionTitle}>News & Updates</ThemedText>
              <ThemedText style={styles.actionDescription}>
                Stay informed about agriculture
              </ThemedText>
            </TouchableOpacity>
          </View>
        </View>
